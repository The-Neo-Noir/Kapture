...
//		  BindingService bindingService = (BindingService) PlatformUI.getWorkbench().getAdapter(IBindingService.class);
		...
		command.addExecutionListener(new  IExecutionListener() {
			...
			public void preExecute(String arg0, ExecutionEvent arg1) {
				...
				try {
					...
					format=KeySequence.getInstance(WorkbenchKeyboard.generatePossibleKeyStrokes(e).get(0).toString()).format();
...
//		
//		workbench.getActiveWorkbenchWindow().getShell().addKeyListener(new org.eclipse.swt.events.KeyListener() {
//			
//			@Override
...
//							
//							System.out.println("Something azmaing  Threadid: "+ event.keyCode+" "+event.keyLocation+" "+event.character+"   "+event.stateMask);
